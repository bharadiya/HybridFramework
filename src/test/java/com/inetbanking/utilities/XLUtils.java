...
public class XLUtils {
	...
	public XLUtils(String path, String SheetNameOrIndex) throws IOException {
		this.path = path;
	...
	public Object[][] fetchAllCellvalue() {
	...
	public String getSheetDAta(int sheetNumber, int row, int coloumn) {
		String data = workbook.getSheetAt(sheetNumber).getRow(row).getCell(coloumn).getStringCellValue(); // focused on
		return data;
	}
}